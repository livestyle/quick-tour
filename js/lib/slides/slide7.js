...
export default function(timeline) {
	...
	timeline.add(time(0), new KeyframeClip(root.querySelector('.qt-livestyle'), {
		0:   {scale: 1},
		100: {scale: 0}
	}));
	...
	timeline.add(time(3000), new TextInputClip('#qt-browser-address-bar-tx1', 'www.my-live-web-site.com', {
		beforeDelay: 1500,
		afterDelay: 2000,
		duration: 1300
	}));
